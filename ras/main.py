...
def main(argv=None):
    parser = argparse.ArgumentParser(description="Ras — your personal AI assistant (Jerry-style)")
    ...
    parser.add_argument("--voice", action="store_true", help="run hands-free voice mode (\"Hey Ras\")")
    ...
    if not bot_token or not app_token:
        ...
        print("  export RAS_SLACK_BOT_TOKEN=xoxb-...")
        print("  export RAS_SLACK_APP_TOKEN=xapp-...")
        print("Or use the no-account web frontend:  ./venv/bin/python -m ras.main --web")
        print("Or test first with:  ./venv/bin/python -m ras.main --cli")
        return 1
    ...
    print("Ras is live on Slack. Press Ctrl+C to stop.")
    try:
        handler.start()
